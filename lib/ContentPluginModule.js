...
class ContentPluginModule extends AbstractApiModule {
  ...
  async installPlugins() {
    ...
    await Promise.all((await fs.readdir(this.getConfig('pluginInstallDir'))).map(async p => {
      const { name, version } = await fs.readJson(`${this.getConfig('pluginInstallDir')}/${p}/bower.json`);
